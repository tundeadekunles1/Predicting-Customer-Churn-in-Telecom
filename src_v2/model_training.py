...
def train_logistic_regression(X_train: pd.DataFrame, y_train: np.ndarray, class_weight=None) -> LogisticRegression:
    model = LogisticRegression(max_iter=5000, class_weight=class_weight, n_jobs=None)
